...
<div class="row">
  ...
  <form class="card col-md-4 mx-auto my-1" method="POST" action="index.php">
    <p>Connaissances</p>
  ...
  <form class="card col-11 mx-auto my-1" method="POST" action="index.php">
    <label>Joindre une image ( jpg ou png )</label>
    <div class="input-group">
      <input type="file" accept=".png, .jpg" class="form-control mb-3 mt-3" id="file" name="file" placeholder="auncun fichier sélectionné." required>
    </div>
